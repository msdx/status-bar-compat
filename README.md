...
[ ![Methods](https://img.shields.io/badge/Methods and size-71 | 10 KB-e91e63.svg) ](http://www.methodscount.com/?lib=com.githang%3Astatus-bar-compat%3A0.4.2)
...
```gradle
    compile 'com.githang:status-bar-compat:0.4.2'
```
